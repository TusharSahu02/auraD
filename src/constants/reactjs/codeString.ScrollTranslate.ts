export const getScrollTranslateCodeString = () => {
  return `
    ...
    gsap.utils.toArray<HTMLElement>(".row").forEach((row, index) => {
      ...
      if (cardLeft && cardRight) {
        const updateTransform = (
          ...
          el.style.transform = \`\translateX($\{progress * x}px) translateY($\{
            progress * y
...
export const getScrollTranslateImportCodeString = () => {
  return `
import ScrollTranslate from "@/perspective-grid/ScrollTranslate";
