    ...
    <div className="bg-[#090716] w-full min-h-screen relative">
      ...
      <div className=" py-2 px-10 flex items-center flex-col justify-center z-20 ">
        <div className=" flex items-center flex-col justify-center pt-24 text-white ">
          ...
          <p className="text-gray-500 text-center mt-5 lg:w-[35%] xl:w-[45%] md:w-1/2">
        ...
        <div className="grid lg:grid-cols-3 grid-cols-1 gap-5 xl:w-[70%] 2xl:w-[60%]  mt-20">
          <div className="border border-white/[0.2] group cursor-pointer  col-span-2 flex items-center justify-start flex-col rounded-lg p-3 space-y-2">
          ...
          <div className="border border-white/[0.2] group cursor-pointer col-span-2 lg:col-span-1  rounded-lg p-3 flex items-center justify-start flex-col space-y-2">
            <div className="border border-white/[0.1] bg-[#1e1e1e3e] overflow-hidden   h-[200px] w-full  rounded-lg">
              <img
                src="https://images.unsplash.com/photo-1614289371518-722f2615943d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"
                alt=""
          ...
          <div className="border border-white/[0.2] group cursor-pointer col-span-2 md:col-span-1 flex items-center justify-start flex-col space-y-2  rounded-lg p-3">
            <div className="border border-white/[0.1] bg-[#1e1e1e3e] overflow-hidden   h-[200px] w-full  rounded-lg">
              <img
                src="https://images.unsplash.com/photo-1614289371518-722f2615943d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"
                alt=""
